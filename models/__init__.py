...
# Importar submodelos para registro no SQLAlchemy
from .estoque import Produto, MovimentacaoEstoque, CategoriaEstoque, UnidadeMedida, SaldoEstoque, NotaFiscalEstoque
from .pulverizacao import (
    ProdutoPulverizacao, Praga, OcorrenciaPraga,
    CronogramaPulverizacao, AplicacaoPulverizacao,
    StatusAplicacao, SeveridadePraga
)
from .alertas import Alerta, PredictaoProducao, ScoreLavoura
